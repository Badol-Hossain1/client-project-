                    ...
                    <div className="flex flex-col md:flex-row md:justify-between md:items-start space-y-8 md:space-y-0">
                        ...
                        <div className="w-full md:w-full">
                            ...
                            <p className="text-sm leading-relaxed">
                                ...
                                BUSINESSES WITH HIGH-CONVERTING LANDING PAGES
                                AND OUTSTANDING USER EXPERIENCES. A TRUE
                            ...
                            <button className="mt-6 flex items-center px-6 py-3 border border-green-400 text-sm font-medium rounded-full text-green-400 hover:bg-green-900 transition-colors duration-200">
                                <a
                                    download
                                    href="https://drive.google.com/uc?export=download&id=1P2S43AoXsBLGtwI-oeybv_JT-HlQVIA0"
                                >
                                    DOWNLOAD MY CV
                                </a>
                            ...
                            <div className="">
                                ...
                                <ul className="space-y-2 text-sm">
                                    ...
                                    <li>
                                        <a
                                            target="_blank"
                                            href="https://dribbble.com/shuvoux"
                                            className="hover:text-white"
                                        >
                                            Work
                                        </a>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm">
                                    <li>
                                        <a
                                            target="_blank"
                                            href="https://www.behance.net/shuvo05"
                                            className="hover:text-white"
                                        >
                                            Behance
                                        </a>
                                    ...
                                    <li>
                                        <a
                                            target="_blank"
                                            href="https://www.linkedin.com/in/raihan-ahamed-shuvo-44a851374/"
                                            className="hover:text-white"
                                        >
                                            Linkedin
                                        </a>
